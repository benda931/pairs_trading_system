...
# =====================
# Part 6/35 – Tab resolver (extracted to core/tab_resolver.py)
# =====================

import importlib          # noqa: E402 – still needed by later parts
...
from core.tab_resolver import (  # noqa: E402
    TAB_RESOLUTION_SPEC,
    TabResolutionResult,
    _find_module,
...
# =====================
# Part 32/35 – Dashboard Alert Bus (extracted to core/alert_bus.py)
# =====================

from core.alert_bus import (  # noqa: E402
    SESSION_KEY_ALERTS,
    DashboardAlert,
    emit_dashboard_alert,
